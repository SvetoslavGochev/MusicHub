    ...
    public class Deserializer
    {
        ...
        public static string ImportProducersAlbums(MusicHubDbContext context, string jsonString)
        {
            ...
            foreach (var producerDto in producersDto)
            {
                ...
                var albums = producerDto.Albums.Select(a => Mapper.Map<Album>(a)).ToList();
        ...
        public static string ImportSongPerformers(MusicHubDbContext context, string xmlString)
        {
            ...
            foreach (var performerDto in performersDto)
            {
                ...
                bool isSongsExists = performerDto.PerformerSongs
                    .Select(s => s.Id)
                ...
                performer.PerformerSongs = performerDto.PerformerSongs
            ...
            context.Performsers.AddRange(performers);
            context.SaveChanges();
